...
def build_excel_report(
    ...
    with pd.ExcelWriter(output, engine="xlsxwriter", engine_kwargs={'options': {'nan_inf_to_errors': True}}) as writer:
        ...
        for qs in summaries:
            ...
            if qs.table.empty:
                worksheet.write(current_row, 0, lang["no_data"])
                current_row += 2
                continue
            ...
            columns = [lang["option"], lang["count"], "%"]
            ...
            if chart_type == 'column':
                ...
                chart.set_x_axis({'name': lang["option"]})
                chart.set_y_axis({'name': lang["count"]})
        ...
        meta_df.to_excel(writer, sheet_name=lang["technical_info"], index=False)
        
        ws_meta = writer.sheets[lang["technical_info"]]
        ws_meta.set_column(0, 0, 40)
        ws_meta.set_column(1, 1, 50)

        # Вихідні дані
        sliced_df.to_excel(writer, sheet_name=lang["raw_data"], index=False)
